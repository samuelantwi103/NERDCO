...
router.put('/:id',           verifyJwt, requireRole('system_admin', 'org_admin'), ctrl.updateVehicle);
router.delete('/:id',        verifyJwt, requireRole('system_admin', 'org_admin'), ctrl.deleteVehicle);
